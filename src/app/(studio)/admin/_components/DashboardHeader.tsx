...
export default function DashboardHeader({
  ...
  return (
    <header className="sticky top-0 z-30 px-8 py-5 bg-white border-b border-gray-3">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-5">
          <Link
            href="/"
            className="flex items-center justify-center border gap-2.5 rounded-lg  px-3 h-11 py-2.5 border-gray-3"
          >
            <svg
