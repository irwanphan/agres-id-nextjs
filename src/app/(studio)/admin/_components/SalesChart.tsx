...
const MonthlyAnalyticsChart = ({ chartData }: DashboardChartProps) => {
  ...
  return (
    <div className="grid w-full grid-cols-1 gap-6 lg:grid-cols-12">
      ...
      <div className="p-6 bg-white border lg:col-span-8 rounded-xl border-gray-3">
      ...
      {/* Pie Chart (4 columns) */}
      <div className="w-full p-6 bg-white border lg:col-span-4 rounded-xl border-gray-3">
        ...
        <div className="flex flex-col items-center ">
          ...
          <div className="flex justify-center gap-4 mt-4 text-sm text-gray-6">
