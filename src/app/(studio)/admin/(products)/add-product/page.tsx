...
export default async function AddProductPage() {
  ...
  return (
    <div className="w-full mx-auto bg-white border rounded-xl shadow-1 border-gray-3 overflow-hidden">
      <div className="px-6 py-5 border-b border-gray-3 sticky top-0 bg-white">
        <h1 className="text-base font-semibold text-dark">Add Product</h1>
      </div>

      <div className="max-h-[calc(70vh)] overflow-y-auto p-6 rounded-xl">
